...
@endsection
@section('content')
    <x-breadcrumb title="Account Settings" pagetitle="Users" />
            ...
            <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <input type="text" class="form-input" placeholder="username" value="Stevens_Laurie"
                            required="">
                    </div>
                    <div class="space-y-2 md:col-span-2">
                        <label>Your email</label>
                        <input type="email" class="form-input" placeholder="Email" value="example@example.com"
                            required="">
                    </div>
                    <div class="space-y-2 md:col-span-2">
                        <label>Profession</label>
                        <input type="text" class="form-input" placeholder="Profession" value="Ui/Ux Designer"
                            required="">
                    </div>
                    <div class="space-y-2 md:col-span-2">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        <label>Website</label>
                        <input type="text" class="form-input" placeholder="Website" value="websiteexample.com"
                            required="">
                    </div>
                    <div class="space-y-2 md:col-span-2">
                        <label>Phone</label>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <button type="button"
                            class="btn bg-purple border border-purple rounded-md text-white transition-all duration-300 hover:bg-purple/[0.85] hover:border-purple/[0.85]">Save</button>
                        <button type="button"
                            class="btn bg-light border border-light rounded-md text-black transition-all duration-300 hover:bg-light/[0.85] hover:border-light/[0.85]">Discard</button>
                    </div>
                </div>
            </div>
            <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div class="flex items-center gap-4">
                        <img src="{{ URL::asset('build/images/user.png') }}" class="w-16 h-16 rounded-full" alt="">
                        <div>
                    ...
                    <div id="FileUpload"
                        class="relative block w-full p-4 border-2 border-dashed rounded appearance-none cursor-pointer border-primary bg-light/20 dark:bg-white/5 dark:border-darkborder">
                        <input type="file" accept="images/*"
                            class="absolute inset-0 z-50 w-full h-full p-0 m-0 outline-none opacity-0 cursor-pointer">
                        <div class="flex flex-col items-center justify-center space-y-3 dark:text-darkmuted">
                            <span
                                class="flex items-center justify-center rounded-full h-14 w-14 bg-light/50 dark:bg-white/10 dark:text-white">
