...
@endsection
@section('content')
    <x-breadcrumb title="Basic Table" pagetitle="Table" />
                    ...
                    <table class="min-w-[640px] w-full">
                        ...
                        <tbody>
                            <tr class="text-muted">
                                ...
                                <td>
                                    <span
                                        class="inline-block items-center rounded text-xs justify-center px-1.5 py-0.5 bg-purple/20 text-purple">Member
                                        </spanc>
                                </td>
                            </tr>
                            <tr class="text-muted">
                                ...
                                <td>
                                    <span
                                        class="inline-block items-center rounded text-xs justify-center px-1.5 py-0.5 bg-success/20 text-success">Admin</span>
                                </td>
                            </tr>
                            <tr class="text-muted">
                                <td>3</td>
                                ...
                                <td>
                                    <span
                                        class="inline-block items-center rounded text-xs justify-center px-1.5 py-0.5 bg-warning/20 text-warning">Member
                                        </spanc>
                                </td>
                            </tr>
                            <tr class="text-muted">
                                ...
                                <td>
                                    <span
                                        class="inline-block items-center rounded text-xs justify-center px-1.5 py-0.5 bg-danger/20 text-danger">Admin</span>
                                </td>
                            </tr>
                            <tr class="text-muted">
                                <td>5</td>
                                ...
                                <td>
                                    <span
                                        class="inline-block items-center rounded text-xs justify-center px-1.5 py-0.5 bg-info/20 text-info">Owner</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="flex items-center -space-x-1.5 rtl:space-x-reverse">
                                        <img class="object-cover w-6 h-6 overflow-hidden rounded-full ring-2 ring-white dark:ring-darkborder"
                                            src="{{ URL::asset('build/images/avatar-12.png') }}" alt="">
                                    </div>
                                </td>
                                <td>3h 20min</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center -space-x-1.5 rtl:space-x-reverse">
                                        <img class="object-cover w-6 h-6 overflow-hidden rounded-full ring-2 ring-white dark:ring-darkborder"
                                            src="{{ URL::asset('build/images/avatar-15.png') }}" alt="">
                                        <img class="object-cover w-6 h-6 overflow-hidden rounded-full ring-2 ring-white dark:ring-darkborder"
                                            src="{{ URL::asset('build/images/avatar-16.png') }}" alt="">
                                        <span
                                            class="flex items-center justify-center object-cover w-6 h-6 text-xs text-center rounded-full bg-light ring-2 ring-white dark:ring-darkborder dark:text-black">+3</span>
                                    </div>
                                </td>
                                <td>78h 05min</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center -space-x-1.5 rtl:space-x-reverse">
                                        <img class="object-cover w-6 h-6 overflow-hidden rounded-full ring-2 ring-white dark:ring-darkborder"
                                            src="{{ URL::asset('build/images/avatar-18.png') }}" alt="">
                                    </div>
                                </td>
                                <td>17h 22min</td>
