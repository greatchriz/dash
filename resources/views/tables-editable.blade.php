...
@endsection
@section('content')
    <x-breadcrumb title="Editable" pagetitle="Table" />
                            ...
                            <template x-for="item in items" :key="item.id">
                                <tr x-show="showElement" x-data="{ showElement: true }">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-input" x-ref="name" x-model="item.name"
                                            x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                    </td>
                                    <td>
                                        <span x-text="item.title"
                                            x-on:dblclick="
                                                        ...
                                                        "
                                            x-show="!item.editing"></span>
                                        <input type="text" class="form-input" x-ref="title" x-model="item.title"
                                            x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                    </td>
                                    <td>
                                        <span x-text="item.phone"
                                            x-on:dblclick="
                                                            item.editing = true;
                                                            $nextTick(() => $refs.phone.focus());
                                                        "
                                            x-show="!item.editing"></span>
                                        <input type="text" class="form-input" x-ref="phone" x-model="item.phone"
                                            x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                    </td>
                                    <td>
                                        <span x-text="item.role"
                                            x-on:dblclick="
                                                            ...
                                                            "
                                            x-show="!item.editing"></span>
                                        <select class="form-select" x-ref="role" x-model="item.role"
                                            x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                            <option>Admin</option>
                                            <option>Owner</option>
                                        </select>
